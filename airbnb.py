...
#python -m streamlit run airbnb.py

warnings.filterwarnings('ignore')

st.set_page_config(page_title="Hello there, creating this webpage for showing my project on AIRBNB",page_icon= None,layout= "wide",initial_sidebar_state= "expanded")
...
#______________________________________BASE_____________________________________________________#
...
#_____________________________________Data exploration________________________________________________________
...
if select == "Data exploration":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\Users\manik\Desktop\project 4")
    df = pd.read_csv("Airbnb NYC 2023.csv", encoding="ISO-8859-1")
